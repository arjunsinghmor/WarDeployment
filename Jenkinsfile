pipeline {
  agent any
	...
	stage('Deploy') {
            steps {
              deploy adapters: [tomcat9(credentialsId: '2b325638-8b5f-4705-b94c-c7c3ccd606ab', path: '', url: 'http://34.213.10.254:8080/')], contextPath: '/', onFailure: false, war: '**/target/*.war'
            }
        }
    }
}
