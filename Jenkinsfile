pipeline {
  agent any
	...
	stage('Deploy') {
            steps {
              deploy adapters: [tomcat9(credentialsId: '2b325638-8b5f-4705-b94c-c7c3ccd606ab', path: '', url: 'http://35.90.243.226:8080/wwp-1.0.0/')], contextPath: '/', onFailure: false, war: '**/target/*.war'
            }
        }
    }
}
